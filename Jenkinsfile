...
//        e.g https://github.com/diy-dinesh/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
//      https://github.com/diy-dinesh/events-app-api-server.git
//      main
//      dtc-jan21-u111
//      api-server-image
//      cnd-cluster 
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/diy-dinesh/events-app-api-server.git'
        ...
        stage('Run Tests') {
         ...
         stage('Build and deploy the container') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cnd-cluster --zone us-central1-a --project dtc-jan21-u111'
